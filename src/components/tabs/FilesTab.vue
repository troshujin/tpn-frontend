          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="file in filteredFiles" :key="file.id" :title="file.name">
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 truncate max-w-[200px]">{{ file.name }}</td>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 truncate max-w-[250px]" :title="`${ file.author.userProxy.firstName } ${ file.author.userProxy.lastName } (${ file.author.userProxy.username })`">
