<template>
  <div class="bg-white shadow-md rounded-lg overflow-hidden p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      <NetworkCard v-for="network in filteredNetworks" :key="network.id" :network="network" :show-join="true"
        @join-network="joinNetwork(network)" />
      <div v-if="!filteredNetworks.length" class="col-span-full text-center p-10 text-gray-500">
