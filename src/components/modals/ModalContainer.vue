    ...
    <div class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
      <div class="flex min-h-screen items-end justify-center px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" aria-hidden="true"
          @click="enableClosing && closeOnOutsideClick ? $emit('close') : () => {}"></div>
        ...
        <div
          ...
          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 h-full flex flex-col">
            <div class="sm:flex sm:items-start h-full flex-1">
              <div class="mt-3 text-center sm:mt-0 sm:text-left w-full h-full flex flex-col">
